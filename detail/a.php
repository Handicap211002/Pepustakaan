...
<body>
    <div class="beranda">
        ...
        <div class="book-detail">
            <div class="book-card">
                <img src="../img/b1.png" alt="Sampul Buku Timun Jelita" class="cover-img" />
                <h2>Hidden-City</h2>
                <p class="author">Mark Steven Lawson</p>
            ...
            <div class="detail-section">
                <h3>Detail Buku</h3>
                <p><strong>Tahun Terbit:</strong> 2025</p>
                <p><strong>Penerbit:</strong> Clearvadersname Pty Ltd</p>

                <h3>Sinopsis</h3>
                <p>
                    Hidden City mengikuti kisah Alf (nama aslinya Jake Christian Langston), seorang mantan pemberontak dan insinyur yang bersembunyi di dunia koloni di pinggiran galaksi. Saat ia dipaksa terlibat dalam operasi ilegal oleh mafia lokal dan polisi korup, ia menemukan lokasi misterius yang diduga milik peradaban asing. Bersama dua rekan baru—seorang mahasiswa komputer dan seorang ahli linguistik—ia menyelidiki bangunan bawah tanah yang tersembunyi di gurun, dengan pintu-pintu berbahasa aneh dan teknologi misterius. Sementara itu, kisah ini juga mengangkat hubungan rumit Alf dengan seorang polisi wanita bernama Ellen, yang awalnya menyelidiki dirinya.
                </p>
                ...
                <div class="button-group">
                    ...
                    <form method="POST" action="pinjam_buku.php">
                        <input type="hidden" name="namabuku" value="Hidden-City">
                        <input type="hidden" name="penciptabuku" value="Mark Steven Lawson">
                        <input type="hidden" name="fotobuku" value="../img/b1.png">
                        <input type="hidden" name="tahunterbit" value="2025">
                        <input type="hidden" name="penerbit" value="Clearvadersname Pty Ltd">
                        <input type="hidden" name="halaman" value="95 lembar">
                        <input type="hidden" name="redirect_to" value="buku.php">
